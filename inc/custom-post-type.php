...
function sunset_contact_add_meta_box() {
	add_meta_box( 'contact_email', 'User Email', 'sunset_contact_email_callbak', 'sunset-contact', 'side', 'high' );
}

function sunset_contact_email_callbak( $post ) {
	wp_nonce_field( 'sunset_save_contact_email_data', 'sunset_contact_email_metabox_nonce' );
...
function sunset_save_contact_email_data( $post_id ) {
	if( ! isset( $_POST['sunset_contact_email_metabox_nonce'] ) ){
		return;
	}
	
	if( ! wp_verify_nonce( $_POST['sunset_contact_email_metabox_nonce'], 'sunset_save_contact_email_data' ) ){
		return;
	}
