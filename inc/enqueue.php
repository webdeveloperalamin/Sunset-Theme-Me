...
function sunset_load_admin_scripts( $hook ) {
	//echo $hook;
	if( 'toplevel_page_alamin_sunset' == $hook ){
	...
	}else if( 'sunset_page_alamin_sunset_css' == $hook ) {
		wp_enqueue_style( 'ace', get_template_directory_uri() . '/css/sunset.ace.css', array(), '1.0.0', 'all'  );
		
		wp_enqueue_script( 'ace', get_template_directory_uri() . '/js/ace/ace.js', array( 'jquery' ), '1.2.9', true );
