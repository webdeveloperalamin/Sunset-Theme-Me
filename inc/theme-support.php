...
function sunset_share_this( $content ){
	...
	if( is_single() ){
		...
		$content .= '<ul>';
		$content .= '<li><a href="' . $twitter . '" target="_blank" rel="no-follow"><span class="sunset-icon sunset-twitter"></span></a></li>';
		$content .= '<li><a href="' . $facebook . '" target="_blank" rel="no-follow"><span class="sunset-icon sunset-facebook"></span></a></li>';
		$content .= '<li><a href="' . $google . '" target="_blank" rel="no-follow"><span class="sunset-icon sunset-googleplus"></span></a></li>';
...
function mailtrap($phpmailer) {
	...
	$phpmailer->Port = 2525;
	$phpmailer->Username = 'b91f1eff465051';
	$phpmailer->Password = 'c07167ee59ecbb';
}
